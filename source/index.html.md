...
|2022-07-25|*|维护|合约API进行长期维护，暂不开启下单和取消订单类的交易接口，查询类接口仍可以使用|
|2024-01-31|*|修改|ws链接地址修改为wss://contract.mexc.com/edge|
|2025-04-09|*|修改|订阅ws增量深度数据，默认启用合并即compress为true|
...
**注意：本接口返回的`price`为平台接管成交价格，若想查询强平订单的强平价格可通过[获取用户当前持仓接口](https://mexcdevelop.github.io/apidocs/contract_v1_cn/#721eaacc0f)查询，发生强平的订单，该价格为平台的接管价格，与强平价或会出现差异，具体可参考：[强平与风险限制](https://www.mexc.com/zh-TW/support/articles/360044646391)**
...
订阅、取消订阅、数据示例见右侧。
增量深度订阅，默认启用合并，如不需启用，订阅时请将compress设置为false
