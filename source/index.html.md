...
Base url: wss://wbs.mexc.com/raw/ws
...
## K-line
Get kline keep updating，interval: Min1、Min5、Min15、Min30、Min60、Hour4、Hour8、Day1、Week1、Month1
...
|interval|string|inteval|
|t|long|dealTime|
|o|decimal|openingPrice|
|c|decimal|closingPrice|
|h|decimal|highestPrice|
|l|decimal|lowestPrice|
|v|decimal|volume|
|q|decimal|quantity|
|e|decimal|earliestDealPrice|
|rh|decimal|realHighestPrice|
|rl|decimal|realLowestPrice|
|tdt|decimal|tradeDealTime|


## Symbol infomation
subscribe symbol infomation
...
| :------ | :-------- | :-------- |
|p|decimal|dealPrice|
|q|decimal|dealQuantity|
|a|decimal|amount|
|t|long|dealTime|
|T|number|dealType:1.buy 2.sell|



## Limited depth
Subscribe to trading pairs with limited depth,available limit: 5, 10, 20，rate: 1time/300ms.
...
| Parameter |  Data Type |  Description|
| :------ | :-------- | :-------- |
|p|decimal|dealPrice|1
|r|decimal|rate|
|v|decimal|24hourVolume|
|q|decimal|24hourQuantity|
|percentChangeVolume24h|decimal|percentChangeVolume24h|
|percentChangeVolumeUtc0|decimal|percentChangeVolumeUtc0|
...
## Private channel
Signature is required for Private channels.

**Authentication method：**

api_key,op and req_time are spliced in dictionary order and spliced with sec_key,and then crypto by MD5.
